          ...
          <tbody>
            ...
            <tr>
             ...
             @endif
              ...
              <td>
                <a href={{ "delete/" . $user->id }} class="btn btn-danger delete-confirm"  onclick="return confirm('Are you sure Delete?')">Trash</a>
                <a href={{ "editdata/" . $user->id }} class="btn btn-info">Edit</a>
              </td>
            </tr>
            @endforeach
          </tbody>
